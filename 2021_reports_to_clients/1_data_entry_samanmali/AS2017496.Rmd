...
setwd("D:/Uni/Year 4/STA 474 2.0 Statistical Consultancy/Client 1")
...
# 1. Structure of data set (worksheets)
...
![](D:/Uni/Year 4/STA 474 2.0 Statistical Consultancy/Client 1/1.png)

*2. Entering all the data of all the firms for a particular year at once followed by the other years.*

![](D:/Uni/Year 4/STA 474 2.0 Statistical Consultancy/Client 1/2.png)


**1.2. Macro-economic data**


![](D:/Uni/Year 4/STA 474 2.0 Statistical Consultancy/Client 1/3.png)
...
Statistical Consultancy Services – USJ
