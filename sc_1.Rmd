...
--
  ...
  - Coaching clients with the interpretation, writing-up and explaing of results
...
- Translate research questions into problems that can be analyzed with data
...
- Client may seek statistical help after data collection, and data do not support to answer the research question
...
- Welcomed the client and made them feel comfortable
...
- Learn about statistical methods standard in the field
